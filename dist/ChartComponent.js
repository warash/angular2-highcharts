...
var ChartComponent = (function () {
    ...
    ChartComponent.prototype.init = function () {
        if (this.userOpts) {
            this.chart = initChart_1.initChart(this.highchartsService, this.userOpts, this.getBaseOptions(), this.type);
    ...
    ChartComponent.prototype.getBaseOptions = function () {
        return createBaseOpts_1.createBaseOpts(this, this.series, this.series ? this.series.point : null, this.xAxis, this.yAxis, this.element.nativeElement);
    };
    __decorate([
